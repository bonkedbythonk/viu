...
@click.command(
    help="Update Anicat to the latest version",
...
\b
  ...
  anicat update --check-only
\b
  # Show release notes for the latest version
  anicat update --release-notes
""",
)
@click.option(
    "--force",
...
def update(
    ...
    """
    Update Anicat to the latest version.
    ...
    if release_notes:
        ...
        if is_latest:
            print("[green]Anicat is up to date![/]")
            ...
            print("[dim]Run 'anicat update' to update[/]")
    else:
