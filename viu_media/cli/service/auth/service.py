...
_XDG_TOKEN_FILE = _XDG_CONFIG_HOME / "viu" / "token.txt"
_XDG_CONFIG_FILE = _XDG_CONFIG_HOME / "viu" / "config.toml"
...
class AuthService:
    ...
    def resolve_token(self, explicit_token: str | None = None) -> str | None:
        ...
        Priority:
            ...
            3. Dedicated token file (~/.config/viu/token.txt or APP_DATA_DIR/token.txt)
